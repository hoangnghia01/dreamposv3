        ...
        <div class="card">
            <div class="card-body">
                                ...
                                <table style="width: 100%;line-height: inherit;text-align: left;">
                                    <tbody><tr>
                                        <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                                            ...
                                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> Table: {{ $order->table->name }}</font></font><br>
                                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;">Created by: {{ $order->created_by }}</font></font><br>

                                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> Guestname: {{ $order->guestname }}</font></font><br>
                                        </td>
                                        {{--  <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                                        ...
                                        <td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
                                            ...
                                            <font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> Status: {{ $order->status }}</font></font><br>
                                        </td>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <a href="{{ route('admin.saleslist') }}" class="btn btn-submit me-2">Back</a>
