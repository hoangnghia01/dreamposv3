                    ...
                    <table class="table datatable ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="{{url('productlist')}}">
                                        <img src="{{URL::asset('assets/img/product/product2.jpg')}}" alt="product">
                                    </a>
                                    <a href="{{url('productlist')}}">Orange</a>
                                </td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>12-12-2022</td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="{{url('productlist')}}">
                                        <img src="{{URL::asset('assets/img/product/product3.jpg')}}" alt="product">
                                    </a>
                                    <a href="{{url('productlist')}}">Pineapple</a>
                                </td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>25-11-2022</td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="{{url('productlist')}}">
                                        <img src="{{URL::asset('assets/img/product/product4.jpg')}}" alt="product">
                                    </a>
                                    <a href="{{url('productlist')}}">Stawberry</a>
                                </td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>19-11-2022</td>
                            ...
                            <tr>
                                ...
                                <td class="productimgname">
                                    <a class="product-img" href="{{url('productlist')}}">
                                        <img src="{{URL::asset('assets/img/product/product5.jpg')}}" alt="product">
                                    </a>
                                    <a href="{{url('productlist')}}">Avocat</a>
                                </td>
                                <td>N/D</td>
                                <td>Fruits</td>
                                <td>20-11-2022</td>
