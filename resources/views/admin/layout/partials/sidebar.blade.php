        ...
        <div id="sidebar-menu" class="sidebar-menu sidebar-menu-three">
            <aside id="aside" class="ui-aside">
                <ul class="tab nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link" id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages"
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link" id="app-tab" data-bs-toggle="tab" data-bs-target="#app"
                            role="tab" aria-controls="app" aria-selected="false">
            ...
            <div class="tab-content tab-content-four pt-2">
                <ul class="tab-pane active" id="home" aria-labelledby="home-tab">
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('admin.product_category.index') }}">Category List</a></li>
                            <li><a href="{{ route('admin.product_category.create') }}">Add Category</a></li>
                            {{--  <li><a href="subcategorylist">Sub Category List</a></li>
                            <li><a href="subaddcategory">Add Sub Category</a></li>  --}}
                            {{--  <li><a href="{{ route('admin.unit.index') }}">Unit List</a></li>
                    ...
                    <li>
                        <a href="{{ route('admin.saleslist') }}"><span> Sales List</span></a>
                    </li>
                    <li>
                        <a href="{{ route('admin.review') }}"><span> Review</span></a>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"><span>Table</span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="{{ route('admin.table.index') }}">Table List</a></li>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li><a href="addsupplier">Add Supplier </a></li>user
                ...
                <ul class="tab-pane" id="messages" aria-labelledby="messages-tab">
                    <li class="submenu">
                        <a href="javascript:void(0);"><span>Admin</span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="{{ route('admin.admin.create') }}">New Admin </a></li>

                            <li><a href="{{ route('admin.admin.index') }}">Amins List</a></li>
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"><span>Cashier</span> <span class="menu-arrow"></span></a>
                        <ul>
                            <li><a href="{{ route('admin.cashier.create') }}">New Cashier </a></li>
                            <li><a href="{{ route('admin.cashier.index') }}">Cashiers List</a></li>
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"><span>Staff</span> <span class="menu-arrow"></span></a>
                        <ul>
                            {{--  <li><a href="{{ route('admin.addStaff') }}">New Staff </a></li>
                            <li><a href="{{ route('admin.listsStaff') }}">Staff List</a></li>  --}}
                        </ul>
                    </li>
                    <li class="submenu">
                        <a href="javascript:void(0);"><span>Customers</span> <span class="menu-arrow"></span></a>
                        <ul>
                            {{--  <li><a href="newuser">New Staff </a></li>  --}}
                            {{--  <li><a href="{{ route('admin.listsCustomer') }}">Customers List</a></li>  --}}
                        </ul>
                    </li>
                </ul>
            ...
            {{--  @if (!Route::is(['index']))
                <ul>
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="{{ Request::is('index-two') ? 'active' : '' }}" >
